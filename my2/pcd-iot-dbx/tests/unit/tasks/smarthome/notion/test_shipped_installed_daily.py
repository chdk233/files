...
def shipped_installed_daily(spark: SparkSession):
    ...
    yield shipped_installed_daily_path
...
def test_shipped_installed_daily(spark,shipped_installed_daily: str):
    ...
    shipped_installed_daily_df = spark.read.json(shipped_installed_daily,schema=shipped_installed_daily_schema)
    ...
    assert ge_df.expect_table_column_count_to_equal(8)
