...
def systems_live_weekly(spark: SparkSession):
    ...
    yield systems_live_weekly_path
...
def test_systems_live_weekly(spark,systems_live_weekly: str):
    ...
    systems_live_weekly_df = spark.read.json(systems_live_weekly,schema=systems_live_weekly_schema)
    ...
    assert ge_df.expect_table_column_count_to_equal(3)
